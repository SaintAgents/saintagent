...
const ENHANCE_OPTIONS = [
  ...
  { id: 'clean_markdown', label: 'Clean Up Markdown', icon: Type, prompt: 'You are a text formatting expert. Clean up this text by converting any raw markdown syntax (##, **, *, etc.) into clean, readable prose. Remove markup symbols, preserve headers as bold lines, make italic text flow naturally, and ensure the result is clean plain text that reads beautifully without any formatting codes. Return ONLY the clean text:' },
  { id: 'article', label: 'Format as Article', icon: Newspaper, prompt: 'You are a professional journalist and article writer. Transform this into a polished, publication-ready article. Structure it with:\n- A compelling headline\n- An engaging opening paragraph\n- Well-organized body sections with clear transitions\n- A strong conclusion\nUse proper prose style — no bullet points unless truly needed. Do NOT use any markdown syntax (no ##, no **, no *, no HTML tags). Write everything as clean plain text. Return ONLY the formatted article text:' },
  { id: 'newsletter', label: 'Newsletter Format', icon: Bold, prompt: 'You are a newsletter design expert. Transform this into a beautifully structured newsletter post. Use:\n- Clear section headings as standalone bold lines\n- Well-spaced paragraphs\n- Bullet points using simple dashes for scannable lists\n- A clear call-to-action or closing\nDo NOT use any markdown syntax (no ##, no **, no *, no HTML tags). Write everything as clean plain text. Return ONLY the formatted newsletter text:' },
  { id: 'professional', label: 'Make Professional', icon: Zap, prompt: 'You are a corporate communications expert. Rewrite this text in a polished, professional business tone. Use precise language, maintain authority and credibility, avoid casual phrases, and ensure it sounds executive-ready. Return ONLY the rewritten text:' },
  ...
  { id: 'add_structure', label: 'Add Structure', icon: List, prompt: 'You are a content architect. Restructure this text into a well-organized, scannable format:\n- Use clear section headers as standalone lines\n- Separate into well-defined paragraphs\n- Use bullet points (- ) for lists and steps\n- Use blank lines to separate major sections\nDo NOT use any markdown syntax (no ##, no **, no *, no HTML tags). Write everything as clean plain text. Return ONLY the structured text:' },
];
