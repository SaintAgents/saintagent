    ...
    <div className="bg-white dark:bg-slate-900 rounded-2xl p-6 space-y-6 min-h-[600px] border border-slate-200 dark:border-slate-700/50">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-7 gap-4">
        ...
        <div className="bg-slate-50 dark:bg-slate-800/50 rounded-xl p-4 border border-slate-200 dark:border-slate-700/50">
          ...
          <div className="text-xs text-slate-500 dark:text-slate-400 uppercase tracking-wider mb-1">MY PROJECTS</div>
      ...
      <div className="bg-slate-50 dark:bg-slate-800/50 rounded-xl p-4 border border-slate-200 dark:border-slate-700/50 inline-block">
        ...
        <div className="text-xs text-slate-500 dark:text-slate-400 uppercase tracking-wider mb-1">TOTAL BUDGET</div>
      ...
      {projects.length === 0 && (
        <div className="text-center py-12">
          ...
          <p className="text-slate-500 mb-4">Create your first project to start tracking tasks and progress</p>
          <Button onClick={() => setCreateProjectOpen(true)} className="bg-emerald-600 hover:bg-emerald-700">
            <Plus className="w-4 h-4 mr-1" />
            Create Project
          </Button>
        </div>
                  ...
                  {projectsByStage[stage.id]?.length === 0 ? (
                    ...
                    projectsByStage[stage.id]?.map((project) => {
                      ...
                      return (
                        <div 
                          key={project.id}
                          className="bg-white dark:bg-slate-800/80 rounded-xl p-4 border border-slate-200 dark:border-slate-700/50 hover:border-blue-300 dark:hover:border-blue-600 cursor-pointer transition-all shadow-sm hover:shadow-md"
