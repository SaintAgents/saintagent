  ...
  "sections": {
    "IDENTITY": [
      ...
      },
      {
        ...
        "how": "User created their account during the genesis interval or holds a genesis code/token.",
      ...
      },
      {
        ...
        "when": "Given to high-trust users selected as reviewers/curators.",
        "how": "User maintains high reputation and trust, completes calibration tasks with good accuracy.",
      ...
      },
      {
        ...
        "when": "Reserved for exceptional members recognized for deep mastery.",
        "how": "User demonstrates long-term service, high integrity, and deep alignment.",
      ...
      },
      {
        ...
        "how": "User maintains an active streak and completes multiple missions within a rolling time window.",
    ...
    "MARKETPLACE": [
      {
        ...
        "when": "Awarded once the user has contributed a meaningful number of listings.",
      ...
      },
      {
        ...
        "how": "User completes a paid mission, sells an item/service, or receives a platform reward in GGG.",
      ...
      },
      {
        ...
        "how": "User reaches a top percentile in sales volume over the last 30 days.",
      ...
      },
      {
        ...
        "definition": "Authorized to trade/handle vault-tier assets.",
        "when": "User is whitelisted or approved for vault-tier asset operations.",
        "how": "User passes extra compliance checks, holds high reputation and trust.",
    ...
    "MISSION": [
      {
        ...
        "definition": "A guide/teacher role signals leadership through challenges.",
        "when": "Granted after the user has successfully mentored others.",
        "how": "User completes multiple mentorship missions with high feedback scores.",
      ...
      },
      {
        ...
        "definition": "Recognized for negotiation, alliance-building, and conflict resolution.",
        "when": "Earned after multiple successful conflict-resolution actions.",
        "how": "User mediates disputes or negotiations with a good success rate.",
      ...
      },
      {
        ...
        "definition": "Trusted caretaker role signals responsibility for community.",
        "when": "Awarded to users who hold ongoing responsibility for a community or project.",
        "how": "User is assigned to steward roles and stays active for a sustained period.",
      ...
      },
      {
        ...
        "definition": "Care/service badge signals healing support.",
        "when": "Granted to users with a strong pattern of providing healing or support.",
        "how": "User completes several support missions with excellent feedback.",
    ...
    "ALIGNMENT": [
      {
        ...
        "how": "User upholds high reputation and trust with no serious alignment flags.",
      ...
      },
      {
        ...
        "when": "Given to users who consistently participate in grid/mission work.",
        "how": "User completes grid-focused missions and logs heart-coherence practices.",
      ...
      },
      {
        ...
        "how": "User completes key 144-path milestones over time.",
      ...
      },
      {
        ...
        "when": "Earned when a user shows a long-standing pattern of committed transformation.",
        "how": "User completes multiple transformative missions over an extended time.",
