  ...
  "sections": {
    "IDENTITY": [
      ...
      },
      {
        ...
        "conditions": { "account_created_in_genesis_window": true },
        "non_transferable": true,
        "requires_manual_approval": false
      },
      {
    ...
    "MARKETPLACE": [
      ...
      },
      {
        ...
        "conditions": { "time_window_days": 30, "min_sales_volume_window": 1000, "min_avg_buyer_rating_window": 4.5 },
        "non_transferable": true,
        "requires_manual_approval": false
      },
      {
    ...
    "MISSION": [
      {
        ...
        "definition": "A guide/teacher role with proven mentorship milestones.",
        "conditions": { "min_mentorship_missions_completed": 5, "min_avg_mentorship_feedback_rating": 4.5, "min_rep_score": 300 },
        "non_transferable": true,
        "requires_manual_approval": false
      },
      {
        ...
        "conditions": { "min_mediation_sessions_completed": 5, "min_conflict_resolution_success_rate": 0.7, "min_rep_score": 250 },
        "non_transferable": true,
        "requires_manual_approval": false
      },
      {
        ...
        "definition": "Trusted caretaker role for community or resources.",
        "conditions": { "min_steward_roles_assigned": 1, "min_days_in_steward_roles": 90, "min_rep_score": 350 },
        "non_transferable": true,
        "requires_manual_approval": false
      },
      {
        ...
        "definition": "Care/service badge for healing support.",
        "conditions": { "min_support_missions_completed": 5, "min_avg_support_feedback_rating": 4.5 },
        "non_transferable": true,
        "requires_manual_approval": false
      },
      {
        ...
        "conditions": { "min_community_growth_missions_completed": 5, "min_community_retention_rate": 0.6 },
        "non_transferable": true,
        "requires_manual_approval": false
      }
    ],
    "ALIGNMENT": [
      ...
      },
      {
        ...
        "conditions": { "min_path_144_milestones_completed": 12, "min_rep_score": 500, "min_trust_percent": 85 },
        "non_transferable": true,
        "requires_manual_approval": false
      },
      {
      ...
      },
      {
        ...
        "conditions": { "min_transformative_missions_completed": 12, "min_rep_score": 550, "min_trust_percent": 88 },
        "non_transferable": true,
        "requires_manual_approval": false
      }
    ]
