// Badge rules configuration data - exported as JS module to avoid JSON parse errors
export const BADGE_RULES_DATA = {
  sections: {
    IDENTITY: [
      {
    ...
    MARKETPLACE: [
      ...
      },
      {
        ...
        definition: "Has earned platform currency (GGG) through activity.",
      ...
      },
      {
        ...
        definition: "Authorized to trade/handle vault-tier assets with trust requirements.",
    ...
    MISSION: [
      ...
      },
      {
        ...
        definition: "Trusted caretaker role for community responsibility.",
        when: "Awarded to users who hold ongoing responsibility for a community or project.",
        how: "User is assigned to steward roles, stays active for a sustained period.",
      ...
      },
      {
        ...
        definition: "Care/service badge for healing support and restoration work.",
