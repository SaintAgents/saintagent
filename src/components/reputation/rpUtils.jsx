...
export const RP_LADDER = [
  ...
  { level: 9, code: 'guardian', title: 'Guardian', min: 7200, nextMin: 10000 }, // cap at 10,000
];

export function getRPRank(points = 0) {
  // Handle below first tier gracefully
  ...
  // Find the tier where points < nextMin (or last tier)
