...
const menuItems = [
  ...
  { id: 'projecttrack', label: 'Project Track', icon: Folder, page: 'ProjectTrack' },
  ...
  { id: 'contentstudio', label: 'Content Studio', icon: Briefcase, page: 'ContentStudio' },
  { id: 'affiliate', label: 'Affiliate', icon: Globe, page: 'AffiliateCenter' },
  { id: 'news', label: 'News', icon: Newspaper, page: 'News' },
  { id: 'videos', label: 'Videos', icon: Activity, page: 'Videos' },
  { id: 'spirittube', label: 'Spirit Tube', icon: Activity, page: 'SpiritTube' },
  ...
  { id: 'resourcehub', label: 'Resources', icon: BookOpen, page: 'ResourceHub' },
  { id: 'advice', label: 'Advice', icon: HelpCircle, page: 'Advice' },
  { id: 'datingmatches', label: 'Dating', icon: Heart, page: 'DatingMatches' },
  { id: 'schedule', label: 'Schedule', icon: Calendar, page: 'Schedule' },
  { id: 'dailyops', label: 'Daily Ops', icon: Activity, page: 'DailyOps' },
  { id: 'notes', label: 'Notes', icon: MessageSquare, page: 'Notes' },
  { id: 'drx', label: 'Digital Rights', icon: Globe, page: 'DigitalRightsExchange' },
  { id: 'gggcrypto', label: 'GGG Crypto', icon: Globe, page: 'GGGCrypto' },
  { id: 'g3dex', label: 'G3 DEX', icon: Globe, page: 'G3Dex' },
  { id: 'treasury', label: 'Treasury', icon: Globe, page: 'GaiaGlobalTreasury' },
  { id: 'lottery', label: 'Lottery', icon: Zap, page: 'Lottery' },
  { id: 'authority144', label: 'Authority 144K', icon: Zap, page: 'Authority144' },
  { id: 'topgggmission', label: 'Top GGG Mission', icon: Target, page: 'TopGGGMission' },
