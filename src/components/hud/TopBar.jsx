...
export default function TopBar({ 
  ...
  return (
    <header className={cn(
      "fixed top-0 bg-white/80 backdrop-blur-lg border-b border-slate-200/60 z-40 flex items-center gap-4 px-6 transition-all duration-300 overflow-x-auto",
      sidebarCollapsed ? "left-0 md:left-20 right-0" : "left-0 md:left-64 right-80",
