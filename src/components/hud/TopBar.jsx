...
const MODE_ICONS = {
  ...
  earn: {
    light: 'https://qtrypzzcjebvfcihiynt.supabase.co/storage/v1/object/public/base44-prod/public/694f3e0401b05e6e8a042002/2a92a8b82_earndark.png',
            ...
            <div key={tab.id} className="flex items-center group relative">
              ...
              >
                <img 
                  src={iconUrl} 
                  alt={tab.label}
                  className={tab.id === 'command' ? "w-7 h-7 object-contain" : "w-8 h-8 object-contain"}
                  data-no-filter="true"
                />
