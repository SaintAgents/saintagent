  ...
  return (
    <>
      ...
      >
        ...
        <div 
          className={cn(
            "fixed right-0 w-[380px] md:w-[380px] max-w-[calc(100vw-1rem)] bg-white dark:bg-[#050505] border border-slate-200 dark:border-[rgba(0,255,136,0.3)] shadow-2xl rounded-l-xl overflow-hidden transition-all duration-300 ease-out",
            showHelpPanel ? "translate-x-0 opacity-100" : "translate-x-full opacity-0 pointer-events-none"
          )}
          style={{ maxHeight: 'calc(100vh - 200px)', bottom: 'calc(5rem + env(safe-area-inset-bottom, 0px))' }}
        >
          {/* Header */}
      ...
      >
        ...
        <div 
          className={cn(
            "fixed right-0 w-[380px] md:w-[380px] max-w-[calc(100vw-1rem)] bg-white dark:bg-[#050505] border border-slate-200 dark:border-[rgba(0,255,136,0.3)] shadow-2xl rounded-l-xl overflow-hidden transition-all duration-300 ease-out flex flex-col",
            showChatPanel ? "translate-x-0 opacity-100" : "translate-x-full opacity-0 pointer-events-none"
          )}
          style={{ height: 'calc(100vh - 260px)', maxHeight: '500px', bottom: 'calc(5rem + env(safe-area-inset-bottom, 0px))' }}
        >
          {/* Header */}
