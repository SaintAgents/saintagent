  ...
  const renderSidebarContent = (inPopup = false) => (
    <>
      ...
      <div className={cn(
        ...
        (isCollapsed && !inPopup) ? "px-2 py-2" : "px-4 py-3"
      )}>
        ...
        {(isCollapsed && !inPopup) ? (
          ...
          <div className="space-y-3">
            ...
            <div className="flex items-center gap-2 px-1">
              ...
              <span className="text-xs font-semibold text-slate-900 uppercase tracking-wide">Appearance</span>
            </div>
      ...
      <div className={cn(
        "border-t border-slate-100 p-4 space-y-3 mb-12",
