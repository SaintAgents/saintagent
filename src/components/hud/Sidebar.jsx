...
export default function Sidebar({ 
  ...
  const renderSidebarContent = (inPopup = false) => (
    <>
      ...
      {/* Theme Section - Always visible, above presence */}
      {(!isCollapsed || inPopup) && (
        <div className="border-t border-slate-100 px-4 py-3 space-y-2">
          <Collapsible open={themeOpen} onOpenChange={setThemeOpen}>
            <CollapsibleTrigger className="w-full flex items-center justify-between py-1.5 px-1 rounded-lg hover:bg-slate-50">
      ...
      <div className={cn(
        "border-t border-slate-100 p-4 pb-14 space-y-3",
