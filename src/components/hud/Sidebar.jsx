    ...
    <>
      ...
      <div className={cn(
        ...
        <Collapsible open={bgEffectOpen} onOpenChange={setBgEffectOpen}>
          <CollapsibleTrigger className="w-full flex items-center justify-between mt-2 py-1.5 px-1 rounded-lg hover:bg-slate-50">
            <span className="text-xs font-semibold text-slate-700 dark:text-[#00ff88] uppercase tracking-wide">Background Effect</span>
            {bgEffectOpen ? <ChevronUp className="w-4 h-4 text-slate-500 dark:text-[#00ff88]" /> : <ChevronDown className="w-4 h-4 text-slate-500 dark:text-[#00ff88]" />}
          </CollapsibleTrigger>
          <CollapsibleContent className="pt-2 space-y-2">
            <RadioGroup value={bgEffect} onValueChange={setBgEffect} className="flex flex-col gap-1.5">
              <div className="flex items-center gap-2">
                ...
                <Label htmlFor={inPopup ? "bg-matrix-pop" : "bg-matrix"} className="text-sm text-slate-700 dark:text-[#00ff88] cursor-pointer flex items-center gap-1.5">
              ...
              <div className="flex items-center gap-2">
                ...
                <Label htmlFor={inPopup ? "bg-starfield-pop" : "bg-starfield"} className="text-sm text-slate-700 dark:text-[#00d4ff] cursor-pointer flex items-center gap-1.5">
              ...
              <div className="flex items-center gap-2">
                ...
                <Label htmlFor={inPopup ? "bg-off-pop" : "bg-off"} className="text-sm text-slate-700 dark:text-slate-400 cursor-pointer flex items-center gap-1.5">
