...
export default function Events() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-violet-50/30 dark:bg-transparent dark:bg-none relative">
      {/* Hero Section */}
      <div className="relative h-64 md:h-72 [html[data-theme='dark']_&]:h-[400px] [html[data-theme='dark']_&]:md:h-[450px] [html[data-theme='hacker']_&]:h-[400px] [html[data-theme='hacker']_&]:md:h-[450px] overflow-hidden page-hero">
        <img 
