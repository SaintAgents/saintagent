    ...
    <div className="min-h-screen bg-transparent">
      <div className={cn(
        ...
        <div className="px-6 pt-6 pb-4">
          ...
          {/* Profile Identifiers */}
          <div className="relative mb-6 p-6 rounded-2xl overflow-hidden bg-slate-900/60 dark:bg-slate-900/60 backdrop-blur-sm border border-slate-700/50" data-avatar-card>
            <div 
              ...
              data-avatar-bg
            />
            <div className="absolute inset-0 rounded-2xl pointer-events-none bg-slate-900/40 dark:bg-slate-900/40" data-avatar-overlay />
            <div className="relative z-10 flex items-start gap-6">
              ...
              <div className="flex-1">
                ...
                {/* Stats Bar */}
                <div className="bg-violet-50 text-neutral-950 mb-4 p-3 opacity-100 rounded-xl grid grid-cols-4 gap-3" data-stats-bar>
        ...
        <div className="px-6 relative min-h-[1200px]">
          ...
          <div className="block space-y-6 mt-6">
            ...
            <CollapsibleCard title="Projects" icon={Folder} defaultOpen={true} backgroundImage="https://images.unsplash.com/photo-1532619187608-e5375cab36aa?w=800&q=80" onPopout={() => setProjectsPopupOpen(true)} forceOpen={cardsForceOpen}>
