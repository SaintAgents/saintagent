                  ...
                  <div className="flex flex-col items-center shrink-0">
                    <div className="relative" style={{ width: '170px', height: '170px' }}>
                      ...
                      <svg 
                        ...
                        viewBox="0 0 100 100"
                      >
                        <circle cx="50" cy="50" r="37" stroke="currentColor" strokeWidth="3" fill="none" className="text-slate-300/50 dark:text-slate-600/50" />
                        <circle cx="50" cy="50" r="37" stroke="url(#trustGradientCmd)" strokeWidth="3" fill="none" strokeDasharray={`${2 * Math.PI * 37}`} strokeDashoffset={`${2 * Math.PI * 37 * (1 - (profile?.trust_score || 0) / 100)}`} className="transition-all duration-700" strokeLinecap="round" />
                        <defs>
