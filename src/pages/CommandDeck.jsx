...
export default function CommandDeck({ theme, onThemeToggle }) {
  ...
  return (
  <div className="min-h-screen cmd-deck-bg pb-20 w-screen max-w-full overflow-x-hidden m-0 p-0">
    <div className={cn(
            ...
            <div className="relative z-10 flex flex-col md:flex-row items-center md:items-start gap-4 md:gap-6">
              ...
              <div className="relative shrink-0" data-user-id={profile?.user_id || currentUser?.email}>
                ...
                <div className="mb-4">
                  ...
                  {/* Featured: Eternal Flame only */}
                  <div className="mb-4">
                    <div className="flex items-center gap-3 p-3 rounded-xl bg-gradient-to-l from-amber-50 to-orange-50 border border-amber-200 max-w-xs">
                      <img
                  ...
                  {/* All earned badges flow into BadgesBar */}
                  <BadgesBar
                    badges={badges}
