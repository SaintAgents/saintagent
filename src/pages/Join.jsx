...
export default function JoinPage() {
  ...
  return (
    <div className="min-h-screen text-white overflow-hidden relative" style={{ background: `linear-gradient(to bottom, rgba(15, 23, 42, 0.7), rgba(15, 23, 42, 0.75), rgba(46, 16, 101, 0.85)), url('https://qtrypzzcjebvfcihiynt.supabase.co/storage/v1/object/public/base44-prod/public/694f3e0401b05e6e8a042002/edba48a5c_gemini-25-flash-image_merge_in_a_cool_way-31.jpg') center/cover fixed` }}>
      {/* Hero Section */}
