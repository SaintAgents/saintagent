...
export default function SynchronicityEngine() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-violet-950/20 to-slate-950 dark:bg-transparent dark:bg-none dark:from-transparent dark:via-transparent dark:to-transparent">
      {/* Hero Section */}
