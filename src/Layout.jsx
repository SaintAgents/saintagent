    ...
    <div className="min-h-screen bg-slate-50">
      ...
      <style>{`
        ...
        [data-theme='light'] main[data-page='CommandDeck'] {
          background-image: linear-gradient(rgba(255,255,255,0.85), rgba(255,255,255,0.85)), url('https://qtrypzzcjebvfcihiynt.supabase.co/storage/v1/object/public/base44-prod/public/694f3e0401b05e6e8a042002/c65131845_gemini-25-flash-image_merge_the_shield_into_the_center-0.jpg');
          background-size: cover;
          background-position: center;
          background-attachment: fixed;
        }
